...
def selftest():
    ...
    b22 = Bot({}, default_state(A))                          # p_eff=0.49: LO bucket sizes at learned qlo
    b22.imp["qlo"], b22.imp["qhi"] = 0.53, 0.50
    s22, w22 = b22._impulse_stake(0.49)
    ok(s22 is not None and s22 >= 1 and w22 is None,
       ...
       f"stake={s22}")
    b23 = Bot({}, default_state(A))                          # p_eff=0.50 exactly: HI bucket per §4.2 [0.50, 0.53]
